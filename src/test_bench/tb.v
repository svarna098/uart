...
//`timescale 1ns/1ps
// ================================================================
//  tb_uart_compare.v    60 Test Cases
//  DUT (top) vs Reference (top_ref)
//
//  FLOW FOR EVERY TEST:
//  ---------------------------------------------------------------
//  STEP 1  run_tx(data):
//    Pulses xmit_h on both DUT and REF simultaneously.
//    Captures the DUT serial output (uart_xmit_data_h) bit-by-bit
//    into captured_frame[] as TX runs.
//    Waits for xmit_done_h, then verifies REF TX matched DUT TX.
//
//  STEP 2  run_rx():
//    Replays captured_frame[] bit-by-bit into dut_rx_in AND
//    ref_rx_in simultaneously at the correct baud rate.
//    Waits for SYNC_SETTLE ticks after stop bit.
//
//  STEP 3  compare_outputs():
//    Checks DUT rec_data_h == REF rec_data_h and other signals.
//    Prints [PASS] or [FAIL].
//
//  NO direct wire between any TX output and any RX input.
//  The captured_frame reg[] is the only bridge.
// ================================================================
